 ...
 * Copyright 2024 Sean 'Shaleh' Perry <shalehperry@gmail.com>
 *
...
// clang-format off
enum layers{
  MAC_BASE, // Switch position 0
  MAC_FN,
  WIN_BASE, // Switch position 1
  WIN_FN,
  MAC_COLEMAK,
  WIN_COLEMAK,
};
...
[MAC_COLEMAK] = LAYOUT_tkl_ansi(
     ...
     CW_TOGG,  KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_SCLN,  KC_ENT,
